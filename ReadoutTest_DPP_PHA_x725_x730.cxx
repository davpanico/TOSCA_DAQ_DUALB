...
int ProgramDigitizer(int handle, DigitizerParams_t Params, CAEN_DGTZ_DPP_PHA_Params_t DPPParams)
{
    ...
    ret |= CAEN_DGTZ_SetRunSynchronizationMode(handle, CAEN_DGTZ_RUN_SYNC_Enabled);
...
int main(int argc, char *argv[])
{
    ...
    for (b = 0; b < MAXNB; b++) {
        ...
        * Communication Parameters   *
        ...
        ret = CAEN_DGTZ_OpenDigitizer(CAEN_DGTZ_USB_A4818_V2718, 23365, 0, 0xXXXXXXXX, &handle[b]);
